Module.register("MMM-EMTAlcobendas",{
	...
	start: function() {
		...
		wrapper.setAttribute("class", "EMTALCOBENDAS");
	...
	getStyles: function() {
		return [
			...
			this.file('MMM-EMTAlcobendas.css'), // this file will be loaded straight from the module folder.
		]
	},
	...
	socketNotificationReceived: function (notification, payload) {
		...
		if (notification === "BUS_INFO"){
			...
			mainDiv.setAttribute("class", "EMTALCOBENDAS");
